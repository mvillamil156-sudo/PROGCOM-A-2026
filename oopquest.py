...
║        ╚═════╝  ╚═════╝ ╚═╝          ╚══▀▀═╝  ╚═════╝ ╚══════╝╚══════╝      ║
║                                                                              ║
║              ★  El RPG donde programar ES el combate  ★                     ║
║                                                                              ║
║  Autor    : Claude (Anthropic) — obra original, libre de derechos            ║
║  Licencia : MIT — uso libre educativo y comercial                            ║
║  Versión  : 1.0.0   |   Python 3.8+   |   Solo stdlib                       ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
